...
public class Minimax {
    ...
    public static Point solve(int[][] board, int player,int depth,StaticEvaluator e){
        nodesExplored = 0;
    ...
    private static int MMAB(int[][] node,int player,int depth,boolean max,int alpha,int beta,StaticEvaluator e){
        nodesExplored++;
